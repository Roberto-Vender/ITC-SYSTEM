    ...
    <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <main className="flex-1 p-8">
        ...
        <div className="mb-8 flex justify-between items-center">
          <div>
            <h1 className="text-blue-600 text-2xl font-bold">Dashboard Overview</h1>
          </div>
...
<div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
  ...
  <div className="bg-white rounded-xl p-6 shadow-md">
    <h3 className="text-xl font-semibold mb-4 text-center">Total Residents</h3>
    <div className="flex items-center justify-center gap-2">
        <svg className="mt-3" width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M31.4062 13.125C31.1773 16.3023 28.8203 18.75 26.25 18.75C23.6797 18.75 21.3187 16.3031 21.0937 13.125C20.8594 9.81953 23.1539 7.5 26.25 7.5C29.3461 7.5 31.6406 9.87969 31.4062 13.125Z" stroke="black" stroke-linecap="round" stroke-linejoin="round"/>
        <path d="M26.2501 23.75C21.1587 23.75 16.2626 26.2789 15.036 31.2039C14.8735 31.8555 15.2821 32.5 15.9516 32.5H36.5493C37.2188 32.5 37.6251 31.8555 37.4649 31.2039C36.2383 26.2 31.3422 23.75 26.2501 23.75Z" stroke="black" stroke-miterlimit="10"/>
        <path d="M15.625 14.5266C15.4422 17.0641 13.5375 19.0625 11.4844 19.0625C9.43126 19.0625 7.52345 17.0648 7.34376 14.5266C7.15704 11.8867 9.01095 10 11.4844 10C13.9578 10 15.8117 11.9352 15.625 14.5266Z" stroke="black" stroke-linecap="round" stroke-linejoin="round"/>
        <path d="M16.0938 23.9063C14.6836 23.2602 13.1305 23.0117 11.4844 23.0117C7.42191 23.0117 3.50784 25.0313 2.52738 28.9648C2.39847 29.4852 2.72503 30 3.25941 30H12.0313" stroke="black" stroke-miterlimit="10" stroke-linecap="round"/>
        </svg>
        <p className="font-medium text-center text-3xl mt-3">450</p>
         </div>
  </div>

  {/* Health Summary */}
  <div className="bg-white rounded-xl p-6 shadow-md">
    <h3 className="text-xl font-semibold mb-4 text-center">Total Staff</h3>
    <div className="flex items-center justify-center gap-2">
        <svg className="mt-3" width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M31.4062 13.125C31.1773 16.3023 28.8203 18.75 26.25 18.75C23.6797 18.75 21.3187 16.3031 21.0937 13.125C20.8594 9.81953 23.1539 7.5 26.25 7.5C29.3461 7.5 31.6406 9.87969 31.4062 13.125Z" stroke="black" stroke-linecap="round" stroke-linejoin="round"/>
        <path d="M26.2501 23.75C21.1587 23.75 16.2626 26.2789 15.036 31.2039C14.8735 31.8555 15.2821 32.5 15.9516 32.5H36.5493C37.2188 32.5 37.6251 31.8555 37.4649 31.2039C36.2383 26.2 31.3422 23.75 26.2501 23.75Z" stroke="black" stroke-miterlimit="10"/>
        ...
        <p className="font-medium text-center text-3xl mt-3">450</p>
          ...
          {/* Requested Services */}
          <div className="bg-white rounded-xl p-6 shadow-md">
         <h3 className="text-xl font-semibold mb-4 text-center"> Recent Consultations</h3>
        <div className="flex items-center justify-center gap-2">
        <p className="font-medium text-center text-2xl mt-3">8 consultations logged this week</p>
         </div>
        </div>
          ...
          {/* Requested Services */}
          <div className="bg-white rounded-xl p-6 shadow-md">
         <h3 className="text-xl font-semibold mb-4 text-center">Newly Registered Residents</h3>
        <div className="flex items-center justify-center gap-2">
        <p className="font-medium text-center text-2xl mt-3">15 new residents this month</p>
         </div>
        </div>
 </div>
        ...
        <div className="grid grid-cols-1 gap-6 w-full"> 
          <section className="mt-5 bg-white w-full p-6 rounded-xl shadow-md border border-blue-100">
            <div className="overflow-x-auto text-2xl text-blue-600 font-semibold">Recent Staff Activity Table
            </div>
              <table className="min-w-full w-full text-sm mt-3 justify-center text-center   gap-20">
                <thead>
                  <tr className="border-b bg-indigo-50 ">
                    <th className=" py-2 px-5 whitespace-nowrap ">Date & Time</th>
                    <th className=" py-2 px-5 whitespace-nowrap">Activity Description</th>
                  </tr>
                </thead> 

                <tbody>
                    <td className="py-3 px-5 ">Oct 21, 2025 • 8:12 AM</td>
                    <td className="py-3 px-5">Logged in to the system</td>
                </tbody>
              </table>
          </section>
        </div>
